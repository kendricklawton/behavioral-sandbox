...
//!
//! This is the durable hardening [ADR 007](docs/adr/007-a-byte-for-byte-reproducible-rootfs-build.md) deferred:
...
//! `EKVM_VENDOR_DIR` to that dir takes every build path offline: [`fetch_one`](crate::artifacts)
...
/// **upstream** (it is what fills the mirror), regardless of any `EKVM_VENDOR_DIR` already set.
pub(crate) fn vendor(dir: Option<PathBuf>) -> Result<()> {
    ...
    println!(
        "\n✓ vendored {count} files + manifest in {}\n  build offline with: EKVM_VENDOR_DIR={} \
