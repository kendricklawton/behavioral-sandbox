//! `eke-channel`, the host↔guest wire protocol for the exec channel.
//!
...
//!   client in `eke-vmm`). Every failure is a typed [`ChannelError`] carrying its `io::Error`
...
pub const EKE_VSOCK_PORT: u32 = 1024;
