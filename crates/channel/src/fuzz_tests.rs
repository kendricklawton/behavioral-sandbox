...
//! channel's fuzzing (the deep, nightly `cargo fuzz` half lives in `fuzz/`).
//!
...
//!
//! **Dependency-free on purpose.** `ekvm-channel` is dependency-free by design and the supply-chain
