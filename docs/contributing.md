...
[`AGENTS.md`](https://github.com/k-henry-org/kvm-ebpf-engine/blob/main/AGENTS.md) at the repo root.

## How the work is organized

Work is organized into sequentially-gated phases in
[`ROADMAP.md`](https://github.com/k-henry-org/kvm-ebpf-engine/blob/main/ROADMAP.md), the **single source
...
license (see [`LICENSE`](https://github.com/k-henry-org/kvm-ebpf-engine/blob/main/LICENSE)).
