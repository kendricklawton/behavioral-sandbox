...
[`AGENTS.md`](https://github.com/k-henry-org/ebpf-kvm-engine/blob/main/AGENTS.md) at the repo root.

## How the work is organized

Work is organized into sequentially-gated phases in
[`ROADMAP.md`](https://github.com/k-henry-org/ebpf-kvm-engine/blob/main/ROADMAP.md), the **single source
...
license (see [`LICENSE`](https://github.com/k-henry-org/ebpf-kvm-engine/blob/main/LICENSE)).
