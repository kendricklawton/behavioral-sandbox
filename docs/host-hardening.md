...
CPU's micro-architecture. `ebpf-kvm-engine doctor` **advises** on the machine-checkable parts (it warns; it
...
- `ebpf-kvm-engine doctor` reports the hard floor (architecture, kernel LTS) and **advises** on the SMT,
