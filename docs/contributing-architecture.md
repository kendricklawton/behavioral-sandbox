...
enforcement (see `AGENTS.md`). The guiding properties are the four core properties:
...
- `crates/guest-agent`, the **in-guest agent** (`guest-agent`): runs one command per connection and
