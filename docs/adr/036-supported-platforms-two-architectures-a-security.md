...
boundary (decision 033). That makes the supported platform a *security* property, not a convenience
...
inputs move underneath a pin. It respects decision 013 (caps fail open) and decision 033 (KVM and the
