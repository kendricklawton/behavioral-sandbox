...
(`fd00:200::/64`, host `::1` / guest `::2`) via an `guest_ip6=` cmdline token a guest sysinit
...
(`fc00::/7`), via the host-tested `probes_common::icmp6_dst_on_link`; ICMPv6 to a routable
